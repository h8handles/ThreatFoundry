...
INTEL_REFRESH_CVE_FEED_LIMIT = int(os.getenv("INTEL_REFRESH_CVE_FEED_LIMIT", "50"))
INTEL_REFRESH_THREAT_ACTOR_MAPPING_LIMIT = int(
    os.getenv("INTEL_REFRESH_THREAT_ACTOR_MAPPING_LIMIT", "500")
)
...
INTEL_CHAT_N8N_ALLOW_LOCAL = os.getenv("INTEL_CHAT_N8N_ALLOW_LOCAL", "true" if DEBUG else "false").lower() == "true"
