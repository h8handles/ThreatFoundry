...
description: Write and update practical project documentation including READMEs, architecture notes, issue writeups, handoff docs, and stakeholder-friendly summaries.
---
...
This skill focuses on useful, readable documentation that matches reality and helps work continue smoothly.
...
1. Identify the audience for the document.
2. Define the practical questions the doc must answer.
3. Describe what the project does in plain language first.
4. Add setup, usage, workflow, and structure details.
5. Include commands, paths, or file references where helpful.
6. End with roadmap, limitations, or next steps if relevant.
7. Verify the document still matches the current code or process.
